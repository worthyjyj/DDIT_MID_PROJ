<%@page import="vo.FreeSelectOptionVO"%>
...
<body>
	...
	<section>
		<form id="freeBoardInsertForm" name="form" method="post" enctype="multipart/form-data" action="<%= request.getContextPath()%>/freeboard/insertBoard.do">
		<input type="hidden" name="pname" value="<%= pname %>"/>
		
		<div class="col-md-6" style="width:1000px; height:50px; margin-left:478px; margin-right:auto; margin-top:20px; border: 1px solid #DCDCDC; border-radius: 5px;">
	...
	<!-- 글작성 섹션 -->
		...
		<div class="col-md-6">
			<!-- 질문게시판 제목 -->
			<input name="f_title" id="f_title" type="text" style="width: 1000px; margin-left : auto; margin-right : auto;"  class="form-control" placeholder="여행에 관한 무엇이든 물어보세요!" >
		</div>
		<hr style="color: #DCDCDC; width: 1000px; margin-left: 480px;">

		<!-- 질문게시판 내용 -->
		<div class="col-md-6">
			<textarea name="f_content" id="f_content" style="width: 1000px; margin-left : auto; margin-right : auto;" class="form-control" rows="10" placeholder="내용을 자유롭게 입력해주세요."></textarea>
		</div>
		
		<hr style="color: #DCDCDC; width: 1000px; margin-left:480px; margin-right:auto;">
		
		<!-- 사진 업로드 -->
		
		  <div class="col-md-6" style="margin-left:450px;">
			<input name="free_pic" id="free_pic" type="file"  style="width:1000px; margin-left:25px;" class="form-control" >
		  </div>
		...
		<div class="col-md-6">
			...
			<button style="font-family: 'NanumSquareNeo-Variable'; width: 300px; border: 1px solid #3CB371; background: #3CB371;" class="btn btn-success" type="submit">등록하기</button>
		</div>
		</form> 
	</section>
	<!--  글 작성 섹션 끝 -->
