...
$(function(){
	...
	//지역은 따로 insert 서블릿으로 보내버리고 
	
	
		
// 	$('#insertBtn').on('click', function(){
<%-- 	  location.href="<%=request.getContextPath()%>/mainboard/mainBoardinsert.do?reg_no="+idxx; --%>
// 	});
				 ...
				 <div class="collapse navbar-collapse" id="navbarSupportedContent">
					<form class="d-flex" role="search"
						...
						<input class="sdata" name="sdata" id="sdata" type="search"
							placeholder="  동행을 찾아보세요!" aria-label="Search" style="margin-top:20px;  width:370px; height:45px; ">
...
$(document).ready(function(){
  ...
  <a class="nav-link" href="<%=request.getContextPath()%>/noticeBoardList.do" style="margin-left: 680px; margin-right:none; color:black; font-size: 1.0em;">공지사항</a>
	...
	<section>
	<form action="<%=request.getContextPath() %>/mainboard/mainBoardinsert.do" method="post" enctype="multipart/form-data">
...
<!-- 			<span name="" id="" style="width:150px; height:30px; margin-left:15px; border:1px solid #DCDCDC">도시명출력</span> -->
		...
		<div class="col-md-6" style="width:1000px; margin-left:auto; margin-right:auto; margin-top:20px; height:40px; border: 1px solid #DCDCDC; border-radius: 5px;">
			...
			<input type="date" name="mb_sdate" style="border:none" >
			<span> - </span>
			<input type="date" name="mb_edate" style="border:none" >
		</div>	
	</section>
	...
	<section>
		<div class="col-md-6" style="margin-left: 450px;">
			<!-- 제목 -->
			<input name="mb_title" id="" type="text" style="width: 1000px;" class="form-control" placeholder="ex) 12월 2박3일 제주도 눈 보러갈 동행 3명 구해요~">
		</div>
		<hr style="color: #DCDCDC; width: 1000px; margin-left: 480px; margin-left:auto; margin-right:auto;">
		
		<div class="col-md-6" style="margin-left:450px;">
			<!-- 내용 -->
			<textarea name="mb_content" id="" style="width: 1000px;" class="form-control" id="" rows="10" placeholder="1. 현재 동행이 있나요? 아니여 없어요 혼자에요"></textarea>
		</div>
		...
		<div class="col-md-6" style="margin-left:450px;">
			<!-- 사진 업로드 -->
			<input name="mb_pic" id="photo" type="file" style="width:1000px" class="form-control" value="한라산.png"><!-- 사진 넣지 않을 때 기본으로 저장될 초기 사진명 변경해야함  -->
		</div>
		<br>
		<div class="col-md-6" style="margin-left:450px;">
			<!-- 이전화면으로 돌아가기 -->
