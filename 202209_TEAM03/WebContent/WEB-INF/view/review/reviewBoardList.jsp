...
<% 
	/* List<ReviewBoardVO> reviewList = (List<ReviewBoardVO>)request.getAttribute("reviewList"); */
  ...
  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
	...
	<section>
		<ul class="nav nav-tabs" style="width:1300px; margin-left:auto; margin-right: auto;">
			...
			<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath() %>/reviewBoardListHit.do">조회수순</a></li>
		</ul>
	</section><br>
		...
		<div class="row" style="width: 1300px; margin-left: auto; margin-right: auto; border: 1px solid #DCDCDC; border-radius: 5px;">				
					...
					<div class="card mb-3" style="width: 410px; margin-left: 18px; margin-top:10px; margin-bottom: 10px">
						<div class="row g-0"> 
							...
							<%
							String imageFile = reviewList2.get(i).getRev_pic();
							
							if(imageFile == null || "".equals(imageFile)){
							%>
								<img src="../images/한라산설산.jpg" class="img-fluid rounded-start" alt="..." style="margin-top: 10px; margin-bottom:10px; height: 170px;">
							<% } else { %>
								<img src="<%=request.getContextPath()%>/freeboard/imageView2.do?p_pic=<%=imageFile %>" class="img-fluid rounded-start"
							...
							<div class="col-md-8">
								<div class="card-body">
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
		 							  ...
		 							  <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493
		 							   0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304
		 							   7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"></path>
		 							   <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" ></path>
									</svg><%= reviewList2.get(i).getReg_name()%></h7> <!-- 여행지역 -->
									<br>
									<br>
									
									<a href="<%= request.getContextPath()%>/reviewboard/reviewBoardDetail.do?rev_no=<%=reviewList2.get(i).getRev_no()%>"><p id="listTitle" class="card-text" style="font-family: 'NanumSquareNeo-Variable';"><%=reviewList2.get(i).getRev_title()%></p></a>
									<br>
		
									<p class="card-text">
									<%-- <a href="<%=request.getContextPath()%>/reviewboard/reviewBoardDetail.do?rev_no=<%=reviewList2.get(i).getReg_no()%>"></a><br> --%>
									
									<a> 
									<img alt="" src="../images/프으사아.jpg" width="30" height="30" style="margin-left: auto; border-radius: 30px;"> 
									<span><%=reviewList2.get(i).getP_name()%></span>
						 			</a>
									...
									<span><%=reviewList2.get(i).getRev_hit() %></span>
									</p>
								</div>
							</div>
						</div>
