...
<% 
	...
	List<ReviewBoardVO> reviewList3 = (List<ReviewBoardVO>)request.getAttribute("reviewList3");
%>
...
<!-- 					</ul> -->
			...
			<div class="col-md-6"
				...
				<form action="<%=request.getContextPath() %>/reviewBoardList.do" method="post">
...
--%>		
	...
	<%}else{
					for(ReviewBoardVO rvo : reviewList3){
	%>	
