	...
	<section>
		<div class="row" style="margin-left: auto; margin-right: auto; margin-top:35px;">
			<div style="height: auto; width: 900px; margin-left:320px;">
				<div>
					<!-- 게시판 제목 출력 -->
					<h3 name="" id="" style="margin-top:20px; margin-left:10px;">12월 제주도 한라산 같이 등산할 분 구해요</h3>
				</div>
				<br>
				...
				<div style="border:1px solid #DCDCDC; border-radius: 5px; width:750px; height: 100px;">
					...
					<!-- 선택한 여행기간을 스판태그에 출력 -->
					<a style="font-size:1.2em; margin-left: 25px;">여행날짜 : </a><span id="">2022.12.5 ~ 2022.12.5</span>	
				</div><br>
