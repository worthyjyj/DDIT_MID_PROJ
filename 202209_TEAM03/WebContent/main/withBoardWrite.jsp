...
<body>
		...
		<nav class="navbar navbar-expand-lg" style="background: white;">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<form class="d-flex" role="search" action=".do?">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<%=request.getContextPath()%>/main/withBoardWrite.jsp">동행게시판글쓰기</a></li>
    <li><a class="dropdown-item" href="#">후기게시판글쓰기</a></li> <!-- 나중에 링크 추가하기  -->
    <li><a class="dropdown-item" href="#">자유게시판글쓰기</a></li> <!-- 나중에 링크 추가하기  -->
  </ul>
</div>
  ...
  <a class="nav-link" href="#" style="margin-left: 680px; margin-right:none; color:black; font-size: 1.0em;">공지사항</a>
	...
	<section>
		<div class="col-md-6" style="margin-left: 450px;">
			<!-- 제목 -->
			<input name="" id="" type="text" style="width: 1000px;" class="form-control" placeholder="ex) 12월 2박3일 제주도 눈 보러갈 동행 3명 구해요~">
		</div>
		<hr style="color: #DCDCDC; width: 1000px; margin-left: 480px; margin-left:auto; margin-right:auto;">
		
		<div class="col-md-6" style="margin-left:450px;">
			<!-- 내용 -->
			<textarea name="" id="" style="width: 1000px;" class="form-control" id="" rows="10" placeholder="1. 현재 동행이 있나요? 아니여 없어요 혼자에요"></textarea>
		</div>
