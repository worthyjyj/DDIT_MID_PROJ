	...
	$('#tag1').on('click',function(){
		...
		$('#goodbye').on('click',function(){
			if(!confirm("정말로 회원 탈퇴를 하시겠습니까?")){
				...
				$.ajax({
					url : "<%=request.getContextPath()%>/leaveGroup.do",
					type : "post",
					data : "id="+vid,
				 ...
				 location.href = "http://localhost/202209_TEAM03/log/login.jsp";
			}
...
<body style="background: #F6F6F6;">
 ...
 <script
		...
		<div class="list-group" style="float :left;">
			...
			<div class="list-group2" style="float :left;">
				<div style="margin-top:15px;">
					<span style="font-size: 25px; margin-left:55px;">회원탈퇴</span>
					...
					<div class="list-group2-inner">
						...
						<%
							...
							<br>
							<input type="text" name="id" id="id" class="input-inner" placeholder="아이디를 입력해주세요" style="width:400px; text-align: center;" value="<%=id %>">
							<br>
							<hr style="margin-right: 50px; margin-left: 50px;">
							
							<span style="font-size: 20px; margin-left:55px;">탈퇴사유</span>
							<hr style="margin-right: 50px; margin-left: 50px;">
							
							<ol style="font-size: 20px; margin-left:55px; cursor: pointer;">
								<li id="tag1">사이트가 불편해서...</li>
								<li id="tag2">부적절한 콘텐츠가 많아서...</li>
								<li id="tag3">여행 갈 일이 없을꺼 같아서...</li>
								<li id="tag4">기타...</li>
							</ol>
							<br>
							<div id="why" class="input-inner-pw" style="background: #F6F6F6; margin-right: 50px; margin-left: 50px; height:50px; width:565px; border: 1px solid #e9e9e9;"></div>
							<br>
							<span style="font-size: 20px; margin-left:55px;">비밀번호</span>
							<hr style="margin-right: 50px; margin-left: 50px;">
							<input type="password" class="input-inner-pw" placeholder="비밀번호 입력" style="margin-right: 50px; margin-left: 50px; width:565px; border: 1px solid #e9e9e9;">
							<br>
							<br>
							<input type="password" class="input-inner-pw" placeholder="재 비밀번호 재입력" style="margin-right: 50px; margin-left: 50px; width:565px; border: 1px solid #e9e9e9;">
							<br>
							<br>
							
							<div style="text-align: center; padding-bottom: 30px;">
								<button id="goodbye" type="button" class="btn btn-light">탈퇴</button>
	...
	<div style="width : 100px; height:100px; clear:both;"></div>
 		...
 		<!-- 푸터 -->
		<footer style="background : white; margin-bottom: none; border-top: 1px solid #DCDCDC" class="text-muted py-5">
		<form>
			<div class="container">
