...
// 리스트 창 - 검색어 없이 모든 게시물 데이터를 최신순으로 받아오는 서블릿 (비동기)
@WebServlet("/mainboard/mainBoardListN.do")
public class MainBoardListN extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 서비스객체로 DB받아오기 
		List<MainJoinVO> list = service.mainBoardListN();
