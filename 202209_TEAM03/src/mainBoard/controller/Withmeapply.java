...
/**
 * 상세보기창에서 동행신청하기를 누르면 쪽지함에 신청한 사람의 정보가 insert되는 서블릿 
 */
@WebServlet("/mainboard/withmeapply.do")
public class Withmeapply extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int res = service.noteinsert(map); 
		String result = ""; 
